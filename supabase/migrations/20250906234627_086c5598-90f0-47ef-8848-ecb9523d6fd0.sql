-- Create enum types for better type safety (with IF NOT EXISTS)
DO $$ BEGIN
...
DROP POLICY IF EXISTS "Users can view messages for their client conversations" ON public.messages;
